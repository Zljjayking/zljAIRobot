...
//        
//        _maskLayer.contentsCenter= CGRectMake(0.1,0.1,0.9,0.9);
//        
...
- (void)drawRect:(CGRect)rect {
     ...
     */
    [path moveToPoint:CGPointMake(0, 50-self.ssheight)];
    
    [path addQuadCurveToPoint:CGPointMake(kScreenWidth, 50-self.ssheight) controlPoint:CGPointMake(kScreenWidth/2.0, self.ssheight+10)];
    
    [path addLineToPoint:CGPointMake(kScreenWidth, 30)];
    [path addLineToPoint:CGPointMake(0, 30)];
    [path addLineToPoint:CGPointMake(0, 50-self.ssheight)];
...
//    CGContextMoveToPoint(context, 220, 110);
//    CGContextAddLineToPoint(context, 220, 90);
//    CGContextAddLineToPoint(context, 240, 90);
//    CGContextAddLineToPoint(context, 240, 110);
//    //    CGContextMoveToPoint(context, 240, 110);
//    CGContextAddArcToPoint(context, 230, 130, 220, 110, 30);
...
//    
//    /*图片*/
//    UIImage *image = [UIImage imageNamed:@"聊天头像"];
