...
@interface DYVCSegmentThree ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    self.page = 0;
    self.blankV = [[blankView alloc]initWithFrame:CGRectMake(kScreenWidth/2.0-40, self.view.center.y/2.0-40, 80, 80) imageName:@"noData" title:@"暂无通知我的数据"];
...
- (void)requestDataWithDic:(NSMutableDictionary *)dic {
    ...
    [HttpRequestEngine getNoticeMeApprovalWithDic:dic completion:^(id obj, NSString *errorStr) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.deptNameLb.text = model.deptName;
