...
@interface DYVCSegmentTwo ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    self.page = 0;
    self.blankV = [[blankView alloc]initWithFrame:CGRectMake(kScreenWidth/2.0-40, self.view.center.y/2.0-40, 80, 80) imageName:@"noData" title:@"暂无待我审批的数据"];
...
- (void)requestDataWithDic:(NSMutableDictionary *)dic {
    ...
    [HttpRequestEngine getMyApprovalWithDic:dic completion:^(id obj, NSString *errorStr) {
