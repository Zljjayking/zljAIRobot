//
//  UpdateOrderDetailViewController.m
//  Financeteam
//
...
@interface UpdateOrderDetailViewController ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,UIImagePickerControllerDelegate,UITextViewDelegate,UINavigationControllerDelegate,LGPhotoPickerViewControllerDelegate,LGPhotoPickerBrowserViewControllerDataSource,LGPhotoPickerBrowserViewControllerDelegate,STPhotoBrowserDelegate,SelectDateTimeDelegate>
{
...
@implementation UpdateOrderDetailViewController
...
#pragma mark 个人服务申请表
    ...
    if (tableView.tag == 100) {
        if (indexPath.section == 0 && indexPath.row == 0) {//申请的贷款额度
            ...
            cell.centerTextView.text = [NSString stringWithFormat:@"%.0f",_orderDetail.tabQuota];
            ...
            cell.centerTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.centerTextView.text = [NSString stringWithFormat:@"%.0f",_orderDetail.tabRepayMonth];
        ...
        if (indexPath.section == 0 && indexPath.row == 0) {  //姓名
            ...
            if ([nodeData.name isEqualToString:@"证件类型"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    if (self.tabUIdType == 1) {
                        if (btn.tag == 20) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUIdType == 2){
                        if (btn.tag == 21) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUIdType == 3){
                        if (btn.tag == 22) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
            ...
            if ([nodeData.name isEqualToString:@"婚姻状况"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    }else if (self.tabUMarry == 2){
                        if (btn.tag == 31) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUMarry == 3){
                        if (btn.tag == 32) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUMarry == 4){
                        if (btn.tag == 33) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
            ...
            if ([nodeData.name isEqualToString:@"最高学历"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    }else if (self.tabUEdu == 2){
                        if (btn.tag == 51) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUEdu == 3){
                        if (btn.tag == 52) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUEdu == 4){
                        if (btn.tag == 53) {
                            btn.tag = YES;
                        }else{
                            btn.tag = NO;
            ...
            cell.personInfoTextView.delegate = self;
            cell.personInfoTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;//UIKeyboardTypeEmailAddress
            ...
            cell.personInfoTextView.delegate = self;
            cell.personInfoTextView.keyboardType = UIKeyboardTypeEmailAddress;//UIKeyboardTypeEmailAddress
            ...
            if ([nodeData.name isEqualToString:@"现住宅类型"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    if (self.tabUHsType == 1) {
                        if (btn.tag == 60) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUHsType == 2){
                        if (btn.tag == 61) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUHsType == 3){
                        if (btn.tag == 62) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                    ...
                    else if (self.tabUHsType == 6){
                        if (btn.tag == 65) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.tabUHsType == 7){
                        if (btn.tag == 66) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
            ...
            if (model.index == 60 ) {
                ...
                cell.centerTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
                cell.centerTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"zuyong"]];
                ...
                cell.centerTextView.delegate = self;
                cell.centerTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
                cell.centerTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"zongyong"]];
                return cell;
                ...
                cell.personInfoTextView.delegate = self;
                cell.personInfoTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"qitazhuzhai"]];
        ...
        if (indexPath.row == 0) {//房产类型
            ...
            if ([nodeData.name isEqualToString:@"房产类型"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    }else if (self.houseType == 2){
                        if (btn.tag == 71) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.houseType == 3){
                        if (btn.tag == 72) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.houseType == 4){
                        if (btn.tag == 73) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
            ...
            cell.personInfoTextView.delegate = self;
            cell.personInfoTextView.text = @"";
            if (![Utils isBlankString:self.dataDic[@"qitafangchan"]]) {
                cell.personInfoTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"qitafangchan"]];
            }
            ...
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"goumaidanjia"]];
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"jianzhumianji"]];
            return cell;
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"chanquanbili"]];
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text =[NSString stringWithFormat:@"%@", self.dataDic[@"daikuannianxian"]];
            return cell;
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"yuegong"]];
            return cell;
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"daikuanyue"]];
            return cell;
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"goumaijiage"]];
            return cell;
            ...
            cell.assetInfiTextView.delegate = self;
            cell.assetInfiTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.assetInfiTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"yuegongdaikuan"]];
            return cell;
            ...
            cell.personInfoTextView.delegate = self;
            cell.personInfoTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"fangchandizhi"]];
            ...
            cell.personInfoTextView.delegate = self;
            cell.personInfoTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"cheliangpinpai"]];
        ...
        if (indexPath.row == 0) {//单位名称
            ...
            if ([nodeData.name isEqualToString:@"单位性质"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    }else if (self.wkType == 2){
                        if (btn.tag == 81) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.wkType == 3){
                        if (btn.tag == 82) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                    ...
                    else if (self.wkType == 7){
                        if (btn.tag == 86) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.wkType == 8){
                        if (btn.tag == 87) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                    ...
                    if (i == 0) {
                        ...
                        [btn mas_makeConstraints:^(MASConstraintMaker *make) {
                            ...
                            make.top.equalTo(cell.mas_top).offset((21)*(((i-1)/3)+1)+4);
                            make.height.mas_equalTo(22);
            ...
            cell.centerTextView.delegate = self;
            cell.centerTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.centerTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"yuezongshouru"]];
            cell.rightLabel.text = @"元";
            ...
            cell.centerTextView.delegate = self;
            cell.centerTextView.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
            cell.centerTextView.text = [NSString stringWithFormat:@"%@",self.dataDic[@"faxinri"]];
            ...
            if ([nodeData.name isEqualToString:@"发薪形式"]) {
                for (int i=0; i<nodeData.BtnArr.count; i++) {
                    ...
                    }else if (self.wkMonType == 2){
                        if (btn.tag == 91) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
                        }
                    }else if (self.wkMonType == 3){
                        if (btn.tag == 92) {
                            btn.selected = YES;
                        }else{
                            btn.selected = NO;
...
-(void)SelectBtnsOnClick:(UIButton *)sender{
    if (sender.tag == 10 || sender.tag == 11) {
       ...
       // _orderDetail.tabUIdType = self.tabUIdType;
        [_personalInfoTableView reloadData];
     ...
     //   _orderDetail.tabUMarry = self.tabUMarry;
        [_personalInfoTableView reloadData];
       ...
       // _orderDetail.tabUChild = self.tabUChild;
        [_personalInfoTableView reloadData];
        ...
        _orderDetail.wkType = self.wkType;
        ...
        _orderDetail.wkMonType = self.wkMonType;
        [_workInfoTableView reloadData];
    }
        ...
        _orderDetail.tabLoan = self.tabLoan;
...
-(void)AddressChooseOnClick:(UIButton *)sender{
    ...
    if (sender.tag == 10) {
        ...
        citiesVC.proAndCityAndAreaBlock = ^(NSString *selectedProName, NSString *selectedCityName, NSString *selectedAreaName, NSString *selectedProID, NSString *selectedCityID, NSString *selectedAreaID) {
            NSInteger num1 = [selectedProID integerValue];
            NSInteger num2 = [selectedCityID integerValue];
            NSInteger num3 = [selectedAreaID integerValue];
            ...
            AddressButtonCell * cell = (AddressButtonCell*)[_personalInfoTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:10 inSection:0]];
...
//        };
        ...
        citiesVC.proAndCityAndAreaBlock = ^(NSString *selectedProName, NSString *selectedCityName, NSString *selectedAreaName, NSString *selectedProID, NSString *selectedCityID, NSString *selectedAreaID) {
            ...
            NSString *str = [NSString stringWithFormat:@"%@ %@ %@",selectedProName,selectedCityName,selectedAreaName];
            _orderDetail.adsProId = num1;
            _orderDetail.adsCityId= num2;
            _orderDetail.adsAreaId = num3;
            returnAddressTwo =str;
            
            AddressButtonCell * cell = (AddressButtonCell*)[_personalInfoTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:13 inSection:0]];
...
//        };
        ...
        citiesVC.proAndCityAndAreaBlock = ^(NSString *selectedProName, NSString *selectedCityName, NSString *selectedAreaName, NSString *selectedProID, NSString *selectedCityID, NSString *selectedAreaID) {
            ...
            NSString *str = [NSString stringWithFormat:@"%@ %@ %@",selectedProName,selectedCityName,selectedAreaName];
            _orderDetail.houseProId = num1;
            _orderDetail.houseCityId = num2;
            _orderDetail.houseAreaId = num3;
            
            returnAddressThree =str;
            AddressButtonCell * cell = (AddressButtonCell*)[_assetInfoTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:3 inSection:0]];
...
//        };
        ...
        citiesVC.proAndCityAndAreaBlock = ^(NSString *selectedProName, NSString *selectedCityName, NSString *selectedAreaName, NSString *selectedProID, NSString *selectedCityID, NSString *selectedAreaID) {
            ...
            NSString *str = [NSString stringWithFormat:@"%@ %@ %@",selectedProName,selectedCityName,selectedAreaName];
            _orderDetail.wkProId = num1;
            _orderDetail.wkCityId = num2;
            _orderDetail.wkAreaId= num3;
            
            returnAddressFour =str;
            AddressButtonCell * cell = (AddressButtonCell*)[_workInfoTableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0]];
...
//    NSString * timeString = [theTimeStr substringToIndex:(theTimeStr.length-8)];
    ...
    if (temp == 1) {
        ...
        _orderDetail.adsTime = [date timeIntervalSince1970]*1000;
    ...
    if (temp == 2) {
        ...
        _orderDetail.adsStarTime = [date timeIntervalSince1970]*1000;
    ...
    if (temp == 3) {
        ...
        _orderDetail.houseDate = [date timeIntervalSince1970]*1000;
    ...
    if (temp == 4) {
       ...
       _orderDetail.carDate = [date timeIntervalSince1970]*1000;
    ...
    if (temp == 5) {
       ...
       _orderDetail.wkDate= [date timeIntervalSince1970]*1000;
...
//    UITextView * tabUIdNum = [self.personalInfoTableView viewWithTag:1005];
    ...
    if (tabQuota.text.length == 0) {
        ...
        [alert show];
    }else if ([Utils isBlankString:IDNum]){
        ...
        NSMutableDictionary * parameters = [self dicWithInterType:@"newOrder" MechProId:_orderDetail.mechProId andTabUserId:loginModel.userId];
...
-(NSMutableDictionary *)dicWithInterType:(NSString *)interType MechProId:(NSInteger)mechProId andTabUserId:(NSInteger)tabUserId{
    ...
    dic[@"id"] = @(_orderDetail.orderID);
    dic[@"tableWorkInfoId"] = @(_orderDetail.tableWorkInfoId);
    dic[@"tableAssetInfoId"] = @(_orderDetail.tableAssetInfoId);
    dic[@"tableUserInfoId"] = @(_orderDetail.tableUserInfoId);
    dic[@"tablePhotoInfoId"] = @(_orderDetail.tablePhotoInfoId);
    dic[@"tableSpecialInfoId"] = @(_orderDetail.tableSpecialInfoId);
    dic[@"tablePersonalInfoId"] = @(_orderDetail.tablePersonalInfoId);
    dic[@"tabCreateTime"] = @(_orderDetail.tabCreateTime);
    dic[@"tabSpeed"] = @(_orderDetail.tabSpeed);
    dic[@"TableFinishTime"] = @(_orderDetail.tableFinishTime);
    dic[@"tabSerMoney"] = @(_orderDetail.tabSerMoney);
    dic[@"tabSerMoneyMech"] = @(_orderDetail.tabSerMoneyMech);
    
    UITextView * tabQuota = [self.psTableView viewWithTag:1000];
    
    dic[@"tabQuota"]= @([tabQuota.text floatValue]);
    
    UITextView * tabRepayMonth = [self.psTableView viewWithTag:1001];
    if (![tabRepayMonth.text isEqual:@"(null)"]) {
        
        dic[@"tabRepayMonth"] = @([tabRepayMonth.text floatValue]);
    }
    
    UITextView * tabTerm = [self.psTableView viewWithTag:1002];
    ...
    if (_orderDetail.proId != 0) {
        
        dic[@"proId"] = @(_orderDetail.proId);
    }
    if (_orderDetail.cityId != 0) {
        dic[@"cityId"] = @(_orderDetail.cityId);
    }
    
    if (_orderDetail.areaId != 0) {
        dic[@"areaId"] = @(_orderDetail.areaId);
    }
    ...
    if (_orderDetail.adsProId != 0) {
        
        dic[@"adsProId"] = @(_orderDetail.adsProId);
    }
    if (_orderDetail.adsCityId != 0) {
        dic[@"adsCityId"] = @(_orderDetail.adsCityId);
    }
    if (_orderDetail.adsAreaId != 0) {
        dic[@"adsAreaId"] = @(_orderDetail.adsAreaId);
    }
    ...
    if (![self.dataDic[@"zuyong"] isEqual:@"(null)"]) {
        dic[@"tabUHsMoney"] = @([self.dataDic[@"zuyong"] integerValue]);
    }
    if (![self.dataDic[@"qitazhuzhai"] isEqual:@"(null)"]) {
    ...
    if (_orderDetail.houseProId != 0) {
        dic[@"houseProId"] = @(_orderDetail.houseProId);
    }
    if (_orderDetail.houseCityId != 0) {
        dic[@"houseCityId"] = @(_orderDetail.houseCityId);
    }
    if (_orderDetail.houseAreaId != 0) {
        dic[@"houseAreaId"] = @(_orderDetail.houseAreaId);
    }
    ...
    if (_orderDetail.wkProId != 0) {
        dic[@"wkProId"] = @(_orderDetail.wkProId);
    }
    if (_orderDetail.wkCityId != 0) {
        dic[@"wkCityId"] = @(_orderDetail.wkCityId);
    }
    if (_orderDetail.wkAreaId != 0) {
        dic[@"wkAreaId"] = @(_orderDetail.wkAreaId);
    }
    ...
    if (_orderDetail.adsTime != 0000000000) {
        dic[@"adsTime"] = @(_orderDetail.adsTime);
    }
    if (_orderDetail.adsStarTime != 0000000000) {
        dic[@"adsStarTime"] = @(_orderDetail.adsStarTime);
    }
    if (_orderDetail.houseDate != 0000000000) {
        dic[@"houseDate"] = @(_orderDetail.houseDate);
    }
    if (_orderDetail.carDate != 0000000000) {
        dic[@"carDate"] = @(_orderDetail.carDate);
    }
    if (_orderDetail.wkDate != 0000000000) {
        dic[@"wkDate"] = @(_orderDetail.wkDate);
    }
...
-(void)GRBtnOnClick:(UIButton *)sender{
    ...
    _orderDetail.tabUHsType = self.tabUHsType;
...
//        
    ...
    _orderDetail.houseType = self.houseType;
}
...
-(void)setData{
    self.tabUSex = _orderDetail.tabUSex;
    self.tabUIdType = _orderDetail.tabUIdType;
    self.tabUMarry = _orderDetail.tabUMarry;
    self.tabUChild = _orderDetail.tabUChild;
    self.tabUEdu = _orderDetail.tabUEdu;
    self.tabUHsType = _orderDetail.tabUHsType;
    self.houseType = _orderDetail.houseType;
    self.wkType = _orderDetail.wkType;
    self.wkMonType = _orderDetail.wkMonType;
    self.tabLoan = _orderDetail.tabLoan;
    
    [self.dataDic setValue:_orderDetail.tabUName forKey:@"xingming"];
    [self.dataDic setValue:_orderDetail.tabUMobile forKey:@"dianhua"];
    [self.dataDic setValue:_orderDetail.tabUIdNum forKey:@"zhengjian"];
    [self.dataDic setValue:_orderDetail.tabUqqNum forKey:@"qq"];
    [self.dataDic setValue:_orderDetail.tabUEmail forKey:@"youxiang"];
    [self.dataDic setValue:_orderDetail.tabURegi forKey:@"hukoudizhi"];
    
    [self.dataDic setValue:_orderDetail.tabUPostAds forKey:@"hukouyoubian"];
    
    [self.dataDic setValue:_orderDetail.tabUAds forKey:@"zhuzhaidizhi"];
    
    [self.dataDic setValue:_orderDetail.tabUPostAdsRegi forKey:@"zhuzhaiyoubian"];
    
    [self.dataDic setValue:_orderDetail.tabUTel forKey:@"zhuzhaidianhua"];
    
    
    [self.dataDic setValue:@(_orderDetail.housePrice) forKey:@"goumaidanjia"];
        

    [self.dataDic setValue:@(_orderDetail.houseArea) forKey:@"jianzhumianji"];

        [self.dataDic setValue:@(_orderDetail.houseProperty) forKey:@"chanquanbili"];
        

        [self.dataDic setValue:@(_orderDetail.houseYear) forKey:@"daikuannianxian"];
        

        [self.dataDic setValue:@(_orderDetail.houseMonth) forKey:@"yuegong"];

    
        [self.dataDic setValue:@(_orderDetail.houseMoney) forKey:@"daikuanyue"];
    
        [self.dataDic setValue:@(_orderDetail.carPrice) forKey:@"goumaijiage"];
    
        [self.dataDic setValue:@(_orderDetail.carMonth) forKey:@"yuegongdaikuan"];
        


        [self.dataDic setValue:_orderDetail.houseDetail forKey:@"fangchandizhi"];
        
    

        [self.dataDic setValue:_orderDetail.carName forKey:@"cheliangpinpai"];
        
    

        [self.dataDic setValue:_orderDetail.wkName forKey:@"danweimingcheng"];
        

        [self.dataDic setValue:_orderDetail.wkAds forKey:@"danweidizhi"];
        

        [self.dataDic setValue:_orderDetail.wkIndu forKey:@"suoshuhangye"];
        

        [self.dataDic setValue:_orderDetail.wkTel forKey:@"danweidianhua"];
        

        [self.dataDic setValue:_orderDetail.wkPart forKey:@"suoshubumen"];
        
 
        [self.dataDic setValue:_orderDetail.wkJob forKey:@"danrenzhiwei"];

    
        [self.dataDic setValue:@(_orderDetail.wkMoney) forKey:@"yuezongshouru"];
        

        [self.dataDic setValue:@(_orderDetail.wkMonDate) forKey:@"faxinri"];
        
    

        [self.dataDic setValue:_orderDetail.dearName forKey:@"peiouxingming"];

        [self.dataDic setValue:_orderDetail.idCard forKey:@"peioushenfen"];
    
        [self.dataDic setValue:_orderDetail.perMobile forKey:@"peioudianhua"];
        
    

        [self.dataDic setValue:_orderDetail.companyName forKey:@"peioudanwei"];
        
    

        [self.dataDic setValue:_orderDetail.companyAddress forKey:@"peioudanweidizhi"];
        

        [self.dataDic setValue:_orderDetail.companyTel forKey:@"peioudanweidianhua"];
        

        [self.dataDic setValue:_orderDetail.perAddress forKey:@"peioujuzhudizhi"];
        
 
        [self.dataDic setValue:_orderDetail.perFamName forKey:@"qinshuxingming"];
        
    
        [self.dataDic setValue:_orderDetail.perFamShip forKey:@"qinshuguanxi"];
        

        [self.dataDic setValue:_orderDetail.perFamMobile forKey:@"qinshudianhua"];
        


        [self.dataDic setValue:_orderDetail.perFamCompany forKey:@"qinshudanwei"];

        [self.dataDic setValue:_orderDetail.perCollName forKey:@"tongshixingming"];
        

        [self.dataDic setValue:_orderDetail.perCollWork forKey:@"tongshizhiwu"];
        

        [self.dataDic setValue:_orderDetail.perCollMobile forKey:@"tongshidianhua"];
        

        [self.dataDic setValue:_orderDetail.perCollCompany forKey:@"tongshidanwei"];
        

        [self.dataDic setValue:_orderDetail.perOtherName forKey:@"qitaxingming"];
        


        [self.dataDic setValue:_orderDetail.perOtherShip forKey:@"qitaguanxi"];


        [self.dataDic setValue:_orderDetail.perOtherMobile forKey:@"qitadianhua"];
        

        [self.dataDic setValue:_orderDetail.perOtherCompany forKey:@"qitadanwei"];
        

        [self.dataDic setValue:@(_orderDetail.tabUHsType) forKey:@"zuyong"];
        

        [self.dataDic setValue:_orderDetail.tabUHsOther forKey:@"qitazhuzhai"];

        [self.dataDic setValue:_orderDetail.houseTypeOther forKey:@"qitafangchan"];

        [self.dataDic setValue:_orderDetail.perKnow forKey:@"zhixiaodaikuan"];

        [self.dataDic setValue:_orderDetail.perTogetherName forKey:@"gongtongdaikuan"];

        [self.dataDic setValue:_orderDetail.tabLoanDetail forKey:@"xiangxishuoming"];
